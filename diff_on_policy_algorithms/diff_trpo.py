...
from diff_on_policy_algorithms.diff_on_policy_algorithm import DiffOnPolicyAlgorithm
...
from diff_off_policy_algorithms.dutils import weighted_mean, weighted_std

class DiffTRPO(DiffOnPolicyAlgorithm):
    """
    ...
    def __init__(
        ...
        # @DIFF
        sample_enhancement: bool = False,
        policy_enhancement: bool = False,
        debug: bool = False,
    ):
        ...
        super().__init__(
            ...
            sample_enhancement=sample_enhancement,
